train <- read.csv('C:/Users/Hp/Desktop/titanic2019/train.csv',stringsAsFactors=F)
test <- read.csv('C:/Users/Hp/Desktop/titanic2019/test.csv',stringsAsFactors=F)
...
write.csv(submit,'WCG_XGBoost_Result1.csv',row.names=F)
...
write.csv(submit,'WCG_XGBoost_Result2.csv',row.names=F)
